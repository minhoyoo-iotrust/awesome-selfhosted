...
- [WAIaaS](https://github.com/minhoyoo-iotrust/WAIaaS) - Self-hosted wallet-as-a-service daemon for AI agents with multi-chain support (EVM + Solana), DeFi operations, and Admin Web UI. ([Source Code](https://github.com/minhoyoo-iotrust/WAIaaS)) `MIT` `Nodejs/Docker`
